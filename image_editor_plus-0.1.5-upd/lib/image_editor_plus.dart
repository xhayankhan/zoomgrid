...
class _SingleImageEditorState extends State<SingleImageEditor> {
  ...
  List<Widget> get filterActions {
    ...
    return [
      IconButton(
        icon: Icon(Icons.arrow_back_ios,color: toptextColor,),
        onPressed: (){
          if(widget.SAS==true)
      ...
      const Spacer(flex: 1,),
      Text( compare==true?'Selected Image':'Edit Image',style: TextStyle(color: toptextColor,fontSize: 18,fontWeight: FontWeight.bold),),

      compare==false? IconButton(
        icon: Icon(Icons.undo,
            color:
                layers.length > 1 || removedLayers.isNotEmpty ? toptextColor : grey),
        onPressed: () {
      ...
      ).paddingSymmetric(horizontal: 8):Text('').paddingSymmetric(horizontal: 8),
      compare==false?IconButton(
        icon: Icon(Icons.redo, color: undoLayers.isNotEmpty ? toptextColor : grey),
        onPressed: () {
      ...
      GestureDetector(
        ...
        child: Icon(
             Icons.compare_sharp,color: toptextColor,

          ),
      ),

      IconButton(
        icon: Icon(Icons.check,color: toptextColor,),
        onPressed: () async {
          resetTransformation();

          var binaryIntList =
              await screenshotController.capture(pixelRatio: pixelRatio,delay: const Duration(milliseconds: 10));
      ...
      body: SafeArea(
                      ...
                      child: Screenshot(
                        ...
                        child: RotatedBox(
                          ...
                          child: Transform(
                            ...
                            child: compare==true?Opacity(opacity:widget.factor=='2'?0.95:widget.factor=='4'?0.9:widget.factor=='8'?0.85:1,child: Image.memory(oldImg!,filterQuality: FilterQuality.low,)):layersStack,
                          ),
                        ),
                      ),
                    ),
        ...
        Padding(
          ...
          child: SafeArea(
            ...
            child:  Obx(()=>
               Stack(
                alignment: top.value==true?Alignment.centerRight:Alignment.centerLeft,
                children: <Widget>[
                //   Builder(
                //     builder: (context) {
                //       if(top.value==true){
                ...
                //     }
                //   ),
            Obx(()=> IconButton(onPressed: (){}, icon: top.value==true?Icon(Icons.arrow_forward_ios):top.value==false?Icon(Icons.arrow_back_ios):Text(''))),
                        ...
                        BottomButton(
                          ...
                          onTap: () async {
                            ...
                            var data = await screenshotController.capture(
                                pixelRatio: pixelRatio,delay: Duration(milliseconds: 10));
    ...
    return Scaffold(
        ...
        body: Container(
         ...
         // color: currentColor == black ? white : black,
          ...
          decoration: BoxDecoration(color: Colors.transparent,image:DecorationImage(image:MemoryImage(image.image),fit: BoxFit.contain ),)
        ),
        bottomNavigationBar: SafeArea(
          child: Container(
            height: 80,
...
//             type: SignatureDrawType.shape,
//           ),
//           decoration: BoxDecoration(color: Colors.orange,image:DecorationImage(image:MemoryImage(image.image),fit: BoxFit.cover ),)
//       ),
//       bottomNavigationBar: SafeArea(
//         child: Container(
//           height: 80,
